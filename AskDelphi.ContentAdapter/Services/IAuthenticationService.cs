...
namespace AskDelphi.ContentAdapter.Services
{
    ...
    public interface IAuthenticationService
    {
        ...
        Task<bool> Login(IOperationContext operationContext, AuthLoginResponse response, KeyValuePair<string, StringValues> authHeader, ClaimTuple[] claims);
        ...
        /// <param name="response">Response object that can be returned on the API.</param>
        /// <returns>true upon success, false otherwise</returns>
        Task<bool> Logout(IOperationContext operationContext, AuthLogoutResponse response);
        ...
        /// <returns>true upon success, false otherwise</returns>
        Task<bool> Refresh(IOperationContext operationContext, AuthRefreshResponse response, string refreshToken);
    }
}
